...
### Оценка: В первую очередь нам необходимо найти замену библиотеке и провести рефакторинг кода с целью улучшения производительности приложения. Мы успеем это сделать к 3 спринту.
### Во вторую очередь поработаем над улучшением системы авторизации. Постараемся доработать к последнему спринту.
### Добавление тестов (хотя бы одного) не столь важно по сравнению с остальным, но не менее необходимо. Возможно к последнему спринту подготовим.
